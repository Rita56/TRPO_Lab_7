...
public class RegistrationNegativeTest {
    ...
    @DisplayName("Регистрация без пароля, некорректный постовый индекс")
    @Description("Негативный тест, проверяющий сценарий с попыткой регистрации\n" +
            "пользователя без указаняи одного или всех обязательных полей для формы\n" +
            "с полными данными о пользователе")
